...
public class NormalDistributionI {
	public static void main(String[] args) {
		...
		double lessThan = in.nextDouble();
		double betweenLow = in.nextDouble();
		double betweenUp = in.nextDouble();
		in.close();

		System.out.format("%.3f%n", cumulative(mean, stdDev, lessThan));
		System.out.format("%.3f%n", cumulative(mean, stdDev, betweenUp) - cumulative(mean, stdDev, betweenLow));
	}
